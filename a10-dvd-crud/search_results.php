<?php
	...
	$sql = "SELECT dvd_titles.dvd_title_id AS ID, dvd_titles.title AS title, genres.genre AS genre, 
...
<body>
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active"><a href="search_results.php">Results</a></li>
	</ol>
				...
				<table class="table table-hover table-responsive mt-4">
					...
					<tbody>
						<?php while($row = $results->fetch_assoc()) :?>
							<tr>
								<td><a href="delete.php?id=<?php echo $row['ID']?>&title=<?php echo $row['title']?>" class="btn btn-outline-danger" onclick="return confirm('You are about to delete DVD <?php echo $row['title']?>.');">Delete</a></td>
								<td> <a href=<?php echo "details.php?name=" . $row['title'] ?>><?php echo $row['title']; ?></a></td>
